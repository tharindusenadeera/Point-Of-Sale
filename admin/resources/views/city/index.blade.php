                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" onclick="getData({{$city->id}})"
                                            ...
                                            @if ($city->status == 1)
                                                <button type="button" onclick="toggleStatus(this)" data-status="0"  data-id="{{$city->id}}"  class="btn  btn-warning btn-xs ">Inactivate</button>
                                            @elseif ($city->status ==  0)
                                                <button type="button"  onclick="toggleStatus(this)" data-status="1"  data-id="{{$city->id}}"  class="btn  btn-success btn-xs ">Activate</button>
                                            @endif
                                    </td>
                                </tr>
                                @endforeach
