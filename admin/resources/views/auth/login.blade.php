...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form id="loginForm">
      ...
      <div class="row">
        <div class="row" id="loginFormErrors">

                  </div>
        <!-- /.col -->
        <div class="col-xs-12" >
          <button type="button" class="btn btn-primary btn-block btn-flat FormSubmit" data-form="loginForm">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
