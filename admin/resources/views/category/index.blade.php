...
@section('content')
    ...
    <section class="content-header">
        <h1>
        Menu Categories
            <small>All the Menu Category</small>
        </h1>
        <ol class="breadcrumb">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" onclick="getData({{$category->id}})"
                                            class="btn  btn-info btn-xs ">Edit/ View</button>

                                            @if ($category->status == 1)
                                                <button type="button" onclick="toggleStatus(this)" data-status="0"  data-id="{{$category->id}}"  class="btn  btn-warning btn-xs ">Inactivate</button>
                                            @elseif ($category->status ==  0)
                                                <button type="button"  onclick="toggleStatus(this)" data-status="1"  data-id="{{$category->id}}"  class="btn  btn-success btn-xs ">Activate</button>
                                            @endif
                                    </td>
                                </tr>
                                @endforeach
